...
| 14 | `INC-13` | Corrige `MAX_SEARCH_RESULTS_PER_CAPACITY` (3→8) para não truncar cores em aparelhos com mais de 3 (15 dos 18 do catálogo); orçamento de páginas reajustado em Zoom/Buscapé/KaBuM!/Bondfaro/Americanas; validado com execução real (Galaxy S26 Ultra, 6 cores observadas) | `.` | `INC-10` | `VERIFIED` |
| 15 | `INC-14` | Profundidade por variante: paginação do documento público de ofertas do Buscapé e teto de agregador 20→60; funil de coleta instrumentado com quarentena de listagens descartadas em acesso/extração/matching; primeira recuperação dirigida por essa quarentena (aliases de cor do iPhone 17 Pro/Pro Max). Rota de sitemap do Carrefour avaliada e descartada com medição | `.` | `INC-13` | `LOCAL_VERIFIED_WITH_EXTERNAL_GATE` |
