...
| 4 | `INC-04` | Catálogo real de iPhone 17, primeira fonte comercial permitida, descoberta ampla governada, proteção de rede e UI separando mercado real do laboratório | `.` | — | `IN_PROGRESS` |
