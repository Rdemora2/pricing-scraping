...
| 11 | `INC-10` | Coletores representam fontes e pesquisam o aparelho internamente; UX seleciona armazenamento e cor em duas etapas com cobertura exata | `.` | `INC-08` | `LOCAL_VERIFIED_WITH_EXTERNAL_GATE` |
